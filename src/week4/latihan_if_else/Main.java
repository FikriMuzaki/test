...
public class Main {
    ...
    public static void main(String[] args) { 
        ...
        System.out.println("Masukan IPK semester 1 : ");
        ipk1 = scan.nextDouble();
        System.out.println("Masukan IPK semester 2 : ");
        ipk2 = scan.nextDouble();
        System.out.println("Masukan IPK semester 3 : ");
        ipk3 = scan.nextDouble();
        System.out.println("Masukan IPK semester 4 : ");
        ipk4 = scan.nextDouble();
        System.out.println("Masukan IPK semester 5 : ");
        ipk5 = scan.nextDouble();
        System.out.println("Masukan IPK semester 6 : ");
        ipk6 = scan.nextDouble();
        System.out.println("Masukan IPK semester 7 : ");
        ipk7 = scan.nextDouble();
        System.out.println("Masukan IPK semester 8 : ");
        ipk8 = scan.nextDouble();
        ipk=(ipk1+ipk2+ipk3+ipk4+ipk5+ipk6+ipk7+ipk8)/8;
        
        if(ipk>3.80 && ipk<=4.00){
            System.out.println("Summa Cum Loude,IPK : "+ipk);;
